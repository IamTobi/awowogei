...
import SkillMock from "./mocks/skill.mock.json";
import { PlayerSkill } from "./player-skill.model";
import { sortAndAssignIcons } from "./utilities/player-skills";
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-900">
      <div className="w-full max-w-md">
        ...
        {loading ? (
          <div className="text-white flex flex-col text-center">Loading...</div>
